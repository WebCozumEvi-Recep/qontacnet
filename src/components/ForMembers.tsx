      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-white mb-5" style={{ fontFamily: "Sora, sans-serif" }}>
              Üyeleriniz sahada daha profesyonel görünür,{" "}
              <span className="gradient-text">fırsatları daha kolay takip eder</span>
            </h2>
            <p className="text-[#AAB3C5] text-lg leading-relaxed mb-8">
              QONTAC Network Card, üyelerin birebir görüşmelerde, sosyal medyada ve saha
              çalışmalarında kendilerini daha kurumsal temsil etmesini sağlar. Kart okutulduğunda
              ziyaretçi; iletişim bilgilerine, ürünlere, iş fırsatına, sosyal medya hesaplarına ve
              bilgi talep formuna tek noktadan ulaşır.
            </p>
              ...
              <div className="h-full w-full overflow-hidden pt-9 pb-6 px-3.5" style={{ background: "#050816" }}>
                ...
                <div className="relative rounded-[1.5rem] p-4 mb-4 text-center overflow-hidden glass-card">
                  ...
                  <div className="relative z-10">
                    <h4 className="text-white font-bold text-base" style={{ fontFamily: "Sora, sans-serif" }}>Ahmet Yılmaz</h4>
                    <p className="text-primary text-xs font-medium">Üst Düzey Yönetici</p>
                    <p className="text-[11px] text-on-surface-variant">Qontac Network</p>
                  </div>
                </div>
                {/* Yuvarlak ikon grid */}
                ...
                <div className="glass-card rounded-2xl p-3.5">
                  <div className="flex items-center gap-2 mb-2.5">
                    ...
                    <span className="text-xs font-semibold text-on-surface">Öne Çıkan Ürünler</span>
                  </div>
        ...
        <div className="relative rounded-3xl p-8 lg:p-12 text-center overflow-hidden glass-card" style={{ border: "1px solid rgba(212,175,55,0.20)" }}>
          ...
          <h3 className="relative z-10 text-2xl lg:text-3xl font-bold text-white mb-4" style={{ fontFamily: "Sora, sans-serif" }}>
            Her tanışma <span className="gradient-text">takip edilebilir bir fırsata</span> dönüşür
          </h3>
          <p className="relative z-10 text-[#AAB3C5] text-base lg:text-lg max-w-3xl mx-auto leading-relaxed">
            QONTAC Network Card sayesinde üyeler, tanıştıkları kişileri kaybetmez. Kart okutulur,
            dijital sayfa açılır, ziyaretçi bilgi alır, form bırakır veya doğrudan iletişime geçer.
            Böylece her görüşme daha profesyonel, daha düzenli ve daha ölçülebilir hale gelir.
          </p>
        </div>
      </div>
    </section>
