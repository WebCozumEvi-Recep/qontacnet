...
export default function ModulYonetimi({
  ...
  useEffect(() => { if (templateId) void load(); /* eslint-disable-next-line react-hooks/exhaustive-deps */ }, [templateId]);
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-on-surface-variant mt-0.5">
            Seçili şablonun kartvizit altında görünecek bölümleri.
            {!aktif && <span className="text-amber-300"> Bu şablon aktif değil — modüller kartvizitte görünmez.</span>}
          </p>
        </div>
